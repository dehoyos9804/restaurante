...
@section('contenido')
    <div class="row">
      <div class="col-md-12">
        <form class="form-horizontal" id="formtipocliente" name="formtipocliente" action="{{route('tipo_cliente.store')}}" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                      <div class="input-group">
                        ...
                        <input type="text" id="nametipocliente" name="nametipocliente" class="form-control" placeholder="escriba un nuevo tipo de cliente" />
                      </div>                                            
                    </div>
                  </div>
                </div>
                           ...
                           <table class="table table-bordered table-striped table-actions table datatable">
                               <thead>
                                ...
                                @foreach($vartipocliente as $tipocliente)
                                  <tr>
                                   <td class="text-center">{{$tipocliente->cod_tipo_cliente}}</td>
                                   <td class="text-center">{{$tipocliente->nombre_tipo_cliente}}</td>
                                   <td>
                                        <a href="{{route('tipo_cliente.edit',['id'=>$tipocliente->cod_tipo_cliente])}}" class="btn btn-default btn-rounded btn-sm">
                                            <span class="fa fa-pencil"></span>
                                        </a>
                                        <a href="{{route('tipo_cliente.delete',['id'=>$tipocliente->cod_tipo_cliente])}}" class="btn btn-danger btn-rounded btn-sm">
