var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="admin-lte/css/theme-default.css"><img src="admin-lte/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="admin-lte/css/theme-brown.css"><img src="admin-lte/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="admin-lte/css/theme-blue.css"><img src="admin-lte/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="admin-lte/css/theme-white.css"><img src="admin-lte/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="admin-lte/css/theme-black.css"><img src="admin-lte/img/themes/black.jpg"/></a>'
        +'</div>'
